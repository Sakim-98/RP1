...
seq_input = args.file_name[0][0] 
seq_output = args.output_file_name[0][0] 

with open (f"{seq_input}", 'r') as f: 
...
with open (f'{seq_output}', 'w') as f: # write the entire thing to a file
    for i in seqs:
        f.write('>'+i + '\n' + '\n')
